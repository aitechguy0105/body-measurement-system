...
if __name__ == '__main__':
    ...
    # data_path    = args['data']
    path_f  = '../data/resized_images/1_front_.jpg'
    path_s  = '../data/resized_images/1_left_.jpg'
    data_path = '../data/measurement/1_front_.npy'
    ...
    for id, val in segments_height.items():
        ...
        sum += val
        cv2.putText(img_f, id, (0, int(val)), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 255), 2)
