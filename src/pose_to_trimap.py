...
def generate_fg_mask(img, keypoints):
    ...
    cv.circle(fg_mask, tuple([int(head_center[0]), int(head_center[1])]), int(0.3*neck_len), (255,255,255), thickness=cv.FILLED)
...
def generate_bg_mask(img, keypoints):
    ...
    cv.circle(bg_mask, tuple([int(head_center[0]), int(head_center[1])]), int(neck_len), (255,255,255), thickness=cv.FILLED)
